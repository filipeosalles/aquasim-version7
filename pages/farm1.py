...
# Info
st.title("AquaSim Project - Farm: Flevoland - Onion")
...
with st.sidebar:
    st.markdown("<p style='text-align: center; font-size: 24px;'><b>Flevoland - Onion</b></p>", unsafe_allow_html=True)
    farm_choice = "Flevoland - Onion"
...
if farm_choice == "Flevoland - Onion":
    farm_geojson_path = 'farms/flevoland.geojson'
    latitude, longitude = 52.637610, 5.736258
    farm_zoom = 15  # Zoom level for Flevoland - Onion
