...
def display_links(repo_link, other_link) -> None:
    ...
    col1.markdown(
        f"<a style='display: block; text-align: center;' href=http://www.agrifirm.com>Agrifirm-NL</a>",
        unsafe_allow_html=True,
    )
    col2.markdown(
        f"<a style='display: block; text-align: center;' href=mailto:f.deoliveirasalles@agrifirm.com>Filipe Salles</a>",
        unsafe_allow_html=True,
    )
